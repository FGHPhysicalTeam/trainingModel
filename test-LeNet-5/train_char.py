...
input_labels = np.array([[0] * 20 for i in range(input_count)])
...
# readout层
W_fc2 = tf.Variable(tf.truncated_normal([1024, 20], stddev=0.1), name="W_fc2")
b_fc2 = tf.Variable(tf.constant(0.1, shape=[20]), name="b_fc2")
...
with tf.Session() as sess:
    ...
    saver.save(sess, ".\\char_model\\my_resnet.ckpt")
